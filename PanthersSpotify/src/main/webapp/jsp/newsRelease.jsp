...
<div class="suggestion-container" id = "release-container">
  <div class="suggestion-container-top">
    <h3 class="suggestion-topic">The Best New Releases</h3>
  </div>
  <div class="line"></div>
  <div class="media">
    <div class="media-left">
      <img src="https://spark.adobe.com/images/landing/examples/blizzard-album-cover.jpg" class="media-object" width=100px height=width>
    </div>
    <div class="media-body">
      <h4 class="media-heading">New Music Friday</h4>
      <p>The hottest new music playlist featuring new tracks from Demi Lovato, Miley Cyrus, and J Balv...</p>
      <p>2,286,745 FOLLOWERS</p>
    </div>
  </div>
</div>
...
<div class="suggestion-container" id = "charts-container">
  <div class="suggestion-container-top">
    <h3 class="suggestion-topic">New Albums and Singles</h3>
