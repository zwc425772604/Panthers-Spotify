...
<script src="${cp}/resources/js/queue.js"></script>
    <div> <h1>Play Queue</h1></div>
				<nav class="navbar navbar-expand-md bg-dark navbar-dark"
				  id="bootstrap-overrides-navbar">
				  <ul class="navbar-nav mr-auto tab" id="navbar-ul">
				    <li class="nav-item">
				      <a class="nav-link tablinks" href="javascript:displayContent('queueDiv')">QUEUE </a>
				    </li>
				    <li class="nav-item">
				      <a class="nav-link tablinks" href="javascript:displayContent('historyDiv')">HISTORY</a>
				    </li>
				  </ul>
				</nav>
            ...
            <h3>Now Playing</h3>
                ...
                <tr>
                  ...
                  <td> Artist Name </td>
                  <td> Album </td>
                  <td> <button class="w3-button more_button"><i class="fa fa-ellipsis-h" aria-hidden="true"></i></button></td>
                  <td> 2:15</td>
                </tr>
					    </tbody>
					  </table>
            ...
            <table class="w3-table-all w3-hoverable" id = "next-playing-table">
             ...
             <tbody>
               <tr>
				...
				<div id="historyDiv" class="w3-container info-table" style="display:none">
          <table class="w3-table-all w3-hoverable" id = "next-playing-table">
           <thead>
             <tr class="w3-light-grey">
               <th></th> <!-- play/pause button -->
